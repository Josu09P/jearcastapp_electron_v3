...
const sourceFile = path.join(buildDir, 'logo-app-menu.png'); // Usamos el nuevo PNG blanco como fuente
...
async function convert() {
    console.log('🚀 Iniciando conversión de PNG Blanco a múltiples tamaños...');
