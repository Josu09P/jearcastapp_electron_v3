...
1.  **Misión**: Mantener un entorno libre de géneros mundanos (pop, rock, reggaeton, etc.) mediante el motor de filtrado en `src/main/services/sacredPolicy.js`.
...
3.  **Filtrado**: El sistema es "Permisivo por defecto". Solo bloquea si encuentra géneros prohibidos en la Blacklist. No exige palabras clave de "santidad" para permitir que artistas locales suenen libremente.
